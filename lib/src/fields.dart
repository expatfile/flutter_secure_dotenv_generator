...
final _fieldKeyChecker = const TypeChecker.typeNamed(
  FieldKey,
  inPackage: 'flutter_secure_dotenv',
);
...
abstract class Field<T> {
  ...
  String? get typePrefix {
    ...
    for (final import in _element.library.firstFragment.libraryImports) {
      ...
      if (importedLib == null || importedLib.identifier != identifier) continue;
...
class EnumField extends Field<String> {
  ...
  String? parseValue() {
    ...
    final values = (type as InterfaceType).element.getters
